 ...
 * @author clara
 */
public class AdminChangeAlienInformation extends javax.swing.JFrame {
    public AdminChangeAlienInformation() {
        initComponents();
        fillCBalien();
        fillCBResAgent();
        fillCBrace();
...
private void fillCBLocation() {
        ...
        try {
            // Fetch the list of locations from the database
            ArrayList<String> locations = Database.getDatabase().fetchColumn("select Benamning from plats");
            // Iterate through the list of location names and add each name to the JComboBox (selectBossCB)
    ...
    private void updateInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateInfoButtonActionPerformed
        ...
        // Check if an alien is selected (not an empty string)
        if (!selectAlienIDcb.getSelectedItem().toString().equals("")) {
            boolean check = true;
            try {
                 // Fetch the alien's email and ID
                ...
                }    // Update phone number if a new number is provided
                ...
                }    // Update location if a new location is selected
                ...
                // Update race if a new race is selected
                if (!selectRace.getSelectedItem().toString().equals("")) {
                    // Fetch IDs of squids, bogs, and worms
                    ...
                    // Delete the alien from the specific race tables if they exist
    ...
    // This method is called when the "Find Agent" button is clicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminChangeAlienInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminChangeAlienInformation().setVisible(true);
            }
        });
}
