 ...
 * @author maxli
 */
public class AlienResetCredentials extends javax.swing.JFrame {
    ...
    //  //Extracting ID from the input field
        ...
        if (check) {
                try{
                // Database query to retrieve Alien_ID based on the provided name
                String idQuery = "SELECT Alien_ID FROM alien where Namn = '" +name +"'";
                 // Database query to retrieve Telefon based on the provided name
                String numberQuery = "SELECT Telefon FROM alien where Namn = '" + name + "'";
                ...
                if (Database.getDatabase().fetchSingle(idQuery).equals(id) || Database.getDatabase().fetchSingle(numberQuery).equals(number)) {
                    ...
                    AlienEnterNewCredential frame = new AlienEnterNewCredential();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlienResetCredentials.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlienResetCredentials().setVisible(true);
            }
        });
    }
