 ...
 * @author maxli
 */
public class AgentAddNewAlien extends javax.swing.JFrame {

    /**
     * Creates new form RegisterNewAlien
     */
    public AgentAddNewAlien() {
        initComponents();
        fillCB();
        fillCBagent();
        setID();
    ...
    private void registerAlienButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerAlienButtonActionPerformed
        ...
        try {
            ...
            if (check) {
                ...
                messageBox.setText("Alien added");
            }
        } catch (InfException ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentAddNewAlien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgentAddNewAlien().setVisible(true);
            }
        });
    }
