 ...
 * @author maxli
 */
public class AgentEnterNewCredential extends javax.swing.JFrame {

    /**
     * Creates new form EnterNewCredential
     */

    public AgentEnterNewCredential() {
        initComponents();
    ...
    private void finalButtonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalButtonResetActionPerformed
        ...
        if (check) {
            if (password1.equals(password2)) {
                String updatePasswordQuery = "UPDATE agent SET Losenord = '" + password1 + "' where Agent_ID = " + id ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgentEnterNewCredential.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgentEnterNewCredential().setVisible(true);
            }
        });
    }
